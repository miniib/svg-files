...
function readUInt32LE(bytes) {
    ...
    function decode(payload, metadata) {
        let res = {};
        let sensorId = payload.deviceInfo.devEui.slice(-4);
    ...
    if (metadataFields !== null)   {
        if (metadataFields.hasOwnProperty("Afdeling")){
            res.department =  {
                "type": "Property",
                "value": metadataFields.Afdeling
            }  
        }
        if (metadataFields.hasOwnProperty("Enhed")){
            res.appliance =  {
                "type": "Property",
                "value": metadataFields.Enhed
            }  
        }        
        if (metadataFields.hasOwnProperty("Lokale")){
            res.room =  {
                "type": "Property",
                "value": metadataFields.Lokale
            }  
        }                     
        if (metadataFields.hasOwnProperty("Etage")){
            res.floor =  {
                "type": "Property",
